...
(define_reservation "lvx_v1_lsu_auxr_auxw_r" "lvx_lsu_u + lvx_tiny_u + lvx_auxr_u + lvx_auxw_u + lvx_issue_u")
...
(define_reservation "lvx_v1_lsu_auxw_r" "lvx_lsu_u + lvx_tiny_u + lvx_auxw_u + lvx_issue_u")
(define_reservation "lvx_v1_lsu_auxw_x_r" "lvx_lsu_u + lvx_tiny_u + lvx_auxw_u + lvx_issue_x2_u")
(define_reservation "lvx_v1_lsu_auxw_y_r" "lvx_lsu_u + lvx_tiny_u + lvx_auxw_u + lvx_issue_x3_u")

(define_reservation "lvx_v1_lsu_auxw_memw_r" "lvx_lsu_u + lvx_memw_u + lvx_tiny_u + lvx_auxw_u + lvx_issue_u")
(define_reservation "lvx_v1_lsu_auxw_memw_x_r" "lvx_lsu_u + lvx_memw_u + lvx_tiny_u + lvx_auxw_u + lvx_issue_x2_u")
(define_reservation "lvx_v1_lsu_auxw_memw_y_r" "lvx_lsu_u + lvx_memw_u + lvx_tiny_u + lvx_auxw_u + lvx_issue_x3_u")
(define_reservation "lvx_v1_lsu_x2_auxw_memw_r" "lvx_lsu_x2_u + lvx_memw_u + lvx_tiny_u + lvx_auxw_u + lvx_issue_u")
(define_reservation "lvx_v1_lsu_x2_auxw_memw_x_r" "lvx_lsu_x2_u + lvx_memw_u + lvx_tiny_u + lvx_auxw_u + lvx_issue_x2_u")
(define_reservation "lvx_v1_lsu_x2_auxw_memw_y_r" "lvx_lsu_x2_u + lvx_memw_u + lvx_tiny_u + lvx_auxw_u + lvx_issue_x3_u")
...
(define_insn_reservation "lvx_v1_cache2" 1 (eq_attr "type" "cache2") "lvx_v1_lsu_x2_memw_r")
(define_insn_reservation "lvx_v1_cache2_x" 1 (eq_attr "type" "cache2_x") "lvx_v1_lsu_x2_memw_x_r")
(define_insn_reservation "lvx_v1_cache2_y" 1 (eq_attr "type" "cache2_y") "lvx_v1_lsu_x2_memw_y_r")
