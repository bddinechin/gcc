...
#ifndef GCC_LVX_MPPA_COS
#define GCC_LVX_MPPA_COS

/* 18.2 Controlling the Compilation Driver {{{  */

#undef DRIVER_SELF_SPECS
#define DRIVER_SELF_SPECS \
  DRIVER_SELF_SPECS_COMMON, "%{lpthread: -pthread} ", "%{pthread:%<pthread}"
...
#define INCLUDE_DEFAULTS                                                      \
  {                                                                           \
    ...
    {FIXED_INCLUDE_DIR, "GCC", 0, 0, 0, LVX_COS_SYSHDR_SUF_SPEC},             \
    { 0, 0, 0, 0, 0, 0 }                                                      \
  }
...
#define LVX_COS_SYSHDR_SUF_SPEC 1
#else
#define LVX_COS_SYSHDR_SUF_SPEC 0
#endif
