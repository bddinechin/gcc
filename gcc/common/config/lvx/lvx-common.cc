...
static const struct default_options lvx_option_optimization_table[] =
  {
...
static void
lvx_option_init_struct (struct gcc_options *opts)
{
...
#define TARGET_OPTION_OPTIMIZATION_TABLE lvx_option_optimization_table
#undef TARGET_OPTION_INIT_STRUCT
#define TARGET_OPTION_INIT_STRUCT lvx_option_init_struct
#undef TARGET_EXCEPT_UNWIND_INFO
#define TARGET_EXCEPT_UNWIND_INFO sjlj_except_unwind_info
#undef TARGET_DEFAULT_TARGET_FLAGS
#define TARGET_DEFAULT_TARGET_FLAGS \
  (MASK_HWLOOP | MASK_SCHED2_DATES | MASK_DIVMOD0_TRAP)
