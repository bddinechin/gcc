...
#define CS_REG     4
#define RND_LOC    16
#define get_round() ((__builtin_lvx_get (CS_REG) >> RND_LOC) & ROUND_MASK)
...
#define FP_SET_EXP_OF(a,exp)   vi2vf((vf2vi((a)) & MAKE_FP(FP_ONE_I,FP_Z_I,FP_MANTISSA_MASK)) | ((exp) << (FP_MANTISSA_SZ)));
#define FP_SET_SIGN_OF(a,sign) vi2vf((vf2vi((a)) & MAKE_FP(FP_Z_I,FP_EXP_MASK,FP_MANTISSA_MASK)) | ((sign) << (FP_SZ - 1)))
...
#define expand_initializer_8(expander, ...) \
  expand_initializer_7(expander, __VA_ARGS__) \
  expand_ ## expander(7, __VA_ARGS__),

#define expand_initializer_7(expander, ...) \
  expand_initializer_6(expander, __VA_ARGS__) \
  expand_ ## expander(6, __VA_ARGS__),

#define expand_initializer_6(expander, ...) \
  expand_initializer_5(expander, __VA_ARGS__) \
  expand_ ## expander(5, __VA_ARGS__),

#define expand_initializer_5(expander, ...) \
  expand_initializer_4(expander, __VA_ARGS__) \
  expand_ ## expander(4, __VA_ARGS__),

#define expand_initializer_4(expander, ...) \
  expand_initializer_3(expander, __VA_ARGS__) \
  expand_ ## expander(3, __VA_ARGS__),

#define expand_initializer_3(expander, ...) \
  expand_initializer_2(expander, __VA_ARGS__) \
  expand_ ## expander(2, __VA_ARGS__),

#define expand_initializer_2(expander, ...) \
  expand_initializer_1(expander, __VA_ARGS__) \
  expand_ ## expander(1, __VA_ARGS__),

#define expand_initializer_1(expander, ...) \
  expand_ ## expander(0, __VA_ARGS__),
...
typedef vf_elt fp_mode __attribute__((__vector_size__ (FP_VECTOR_DEPTH * sizeof(vf_elt))));
typedef vi_elt i_mode  __attribute__((__vector_size__ (FP_VECTOR_DEPTH * sizeof(vi_elt))));

static inline fp_mode_1
CONCAT2 (__builtin_lvx_select, fp_suffix_1) (fp_mode_1 a, fp_mode_1 b, i_mode_1 sel, const char UNUSED (*mode))
{
  fp_mode_1 res = { CONCAT2 (__builtin_lvx_selectf, fp_suffix_0) (*(vf_elt*)&a, *(vf_elt*)&b, *(vi_elt*)&sel, ".dnez") };
  return res;
}

static inline fp_mode_1
CONCAT2 (__builtin_lvx_fsrec, fp_suffix_1) (fp_mode_1 a, const char *mode)
{
  if (!__builtin_strcmp (mode, ".s")) {
    fp_mode_1 res = { CONCAT2 (__builtin_lvx_fsrec, fp_suffix_0) (*(vf_elt *)&a, ".s") };
    return res;
  } else {
    fp_mode_1 res = { CONCAT2 (__builtin_lvx_fsrec, fp_suffix_0) (*(vf_elt *)&a, "") };
    return res;
  }
}

#if xFP_TYPE==xDOUBLE && FP_VECTOR_DEPTH > 1
static inline fp_mode
CONCAT2 (__builtin_lvx_frec, fp_suffix) (fp_mode a, const char UNUSED(*mode))
{
  return a;
}
#endif
...
static inline fp_mode_1
CONCAT2 (__builtin_lvx_frec, fp_suffix_1) (fp_mode_1 a, const char UNUSED(*mode))
{
#if xFP_TYPE==xFLOAT
  if (!__builtin_strcmp (mode, ".s")) {
    fp_mode_1 res = { CONCAT2 (__builtin_lvx_frec, fp_suffix_0) (*(vf_elt *)&a, ".s") };
    return res;
  } else {
    fp_mode_1 res = { CONCAT2 (__builtin_lvx_frec, fp_suffix_0) (*(vf_elt *)&a, "") };
    return res;
  }
#else
  return a;
...
static inline fp_mode_1
CONCAT2 (__builtin_lvx_ffms, fp_suffix_1) (fp_mode_1 a, fp_mode_1 b, fp_mode_1 c, const char UNUSED(*mode))
{

  if (!__builtin_strcmp (mode, ".rn.s")) {
    fp_mode_1 res = { CONCAT2 (__builtin_lvx_ffms, fp_suffix_0) (*(vf_elt *)&a, *(vf_elt *)&b, *(vf_elt *)&c, ".rn.s") };
    return res;
  } else if (!__builtin_strcmp (mode, ".ru.s")) {
    fp_mode_1 res = { CONCAT2 (__builtin_lvx_ffms, fp_suffix_0) (*(vf_elt *)&a, *(vf_elt *)&b, *(vf_elt *)&c, ".ru.s") };
    return res;
  } else if (!__builtin_strcmp (mode, ".rd.s")) {
    fp_mode_1 res = { CONCAT2 (__builtin_lvx_ffms, fp_suffix_0) (*(vf_elt *)&a, *(vf_elt *)&b, *(vf_elt *)&c, ".rd.s") };
    return res;
  } else if (!__builtin_strcmp (mode, ".rz.s")) {
    fp_mode_1 res = { CONCAT2 (__builtin_lvx_ffms, fp_suffix_0) (*(vf_elt *)&a, *(vf_elt *)&b, *(vf_elt *)&c, ".rz.s") };
    return res;
  } else {
    fp_mode_1 res = { CONCAT2 (__builtin_lvx_ffms, fp_suffix_0) (*(vf_elt *)&a, *(vf_elt *)&b, *(vf_elt *)&c, "") };
    return res;
  }
}

static inline fp_mode_1
CONCAT2 (__builtin_lvx_ffma, fp_suffix_1) (fp_mode_1 a, fp_mode_1 b, fp_mode_1 c, const char *mode)
{

  if (!__builtin_strcmp (mode, ".rn.s")) {
    fp_mode_1 res = { CONCAT2 (__builtin_lvx_ffma, fp_suffix_0) (*(vf_elt *)&a, *(vf_elt *)&b, *(vf_elt *)&c, ".rn.s") };
    return res;
  } else if (!__builtin_strcmp (mode, ".ru.s")) {
    fp_mode_1 res = { CONCAT2 (__builtin_lvx_ffma, fp_suffix_0) (*(vf_elt *)&a, *(vf_elt *)&b, *(vf_elt *)&c, ".ru.s") };
    return res;
  } else if (!__builtin_strcmp (mode, ".rd.s")) {
    fp_mode_1 res = { CONCAT2 (__builtin_lvx_ffma, fp_suffix_0) (*(vf_elt *)&a, *(vf_elt *)&b, *(vf_elt *)&c, ".rd.s") };
    return res;
  } else if (!__builtin_strcmp (mode, ".rz.s")) {
    fp_mode_1 res = { CONCAT2 (__builtin_lvx_ffma, fp_suffix_0) (*(vf_elt *)&a, *(vf_elt *)&b, *(vf_elt *)&c, ".rz.s") };
    return res;
  } else {
    fp_mode_1 res = { CONCAT2 (__builtin_lvx_ffma, fp_suffix_0) (*(vf_elt *)&a, *(vf_elt *)&b, *(vf_elt *)&c, "") };
    return res;
  }
}

static inline fp_mode_1
CONCAT2 (__builtin_lvx_fmul, fp_suffix_1) (fp_mode_1 a, fp_mode_1 b, const char *mode)
{
  if (!__builtin_strcmp (mode, ".rn.s")) {
    fp_mode_1 res = { CONCAT2 (__builtin_lvx_fmul, fp_suffix_0) (*(vf_elt *)&a, *(vf_elt *)&b, ".rn.s") };
    return res;
  } else if (!__builtin_strcmp (mode, ".ru.s")) {
    fp_mode_1 res = { CONCAT2 (__builtin_lvx_fmul, fp_suffix_0) (*(vf_elt *)&a, *(vf_elt *)&b, ".ru.s") };
    return res;
  } else if (!__builtin_strcmp (mode, ".rd.s")) {
    fp_mode_1 res = { CONCAT2 (__builtin_lvx_fmul, fp_suffix_0) (*(vf_elt *)&a, *(vf_elt *)&b, ".rd.s") };
    return res;
  } else if (!__builtin_strcmp (mode, ".rz.s")) {
    fp_mode_1 res = { CONCAT2 (__builtin_lvx_fmul, fp_suffix_0) (*(vf_elt *)&a, *(vf_elt *)&b, ".rz.s") };
    return res;
  } else {
    fp_mode_1 res = { CONCAT2 (__builtin_lvx_fmul, fp_suffix_0) (*(vf_elt *)&a, *(vf_elt *)&b, "") };
    return res;
  }
}

static inline i_mode_1
CONCAT2 (__builtin_lvx_bitcnt, fp_suffix_1) (i_mode_1 a, const char UNUSED(*mode))
{
    i_mode_1 res = { CONCAT2 (__builtin_lvx_bitcnt, fp_suffix_0) (*(vi_elt *)&a, ".lz") };
    return res;
}

#define __builtin_lvx_fmul     CONCAT2 (__builtin_lvx_fmul,fp_suffix)
#define __builtin_lvx_ffms     CONCAT2 (__builtin_lvx_ffms,fp_suffix)
#define __builtin_lvx_ffma     CONCAT2 (__builtin_lvx_ffma,fp_suffix)
#define __builtin_lvx_select   CONCAT2 (__builtin_lvx_select,fp_suffix)
#define __builtin_lvx_fsrec    CONCAT2 (__builtin_lvx_fsrec,fp_suffix)
#define __builtin_lvx_frec     CONCAT2 (__builtin_lvx_frec,fp_suffix)
#define __builtin_lvx_bitcnt   CONCAT2 (__builtin_lvx_bitcnt,fp_suffix)

static inline fp_mode_1
CONCAT2 (dbl2, fp_mode_1) (vf_elt d) {
  fp_mode_1 res;
  __builtin_memcpy ((void *)&res, (void *)&d, sizeof d);
  return res;
}

static inline vf_elt
CONCAT2 (fp_mode_1, 2dbl) (fp_mode_1 d) {
  vf_elt res;
  __builtin_memcpy ((void *)&res, (void *)&d, sizeof d);
  return res;
}
...
vf                                                                            \
CONCAT3 (__divm3, _, mode) (vf a, vf b)                                       \
{                                                                             \
   ...
   **/                                                                        \
  vi lza = __builtin_lvx_bitcnt (a_m, ".lz") - (FP_SIGN_SZ + FP_EXP_SZ);      \
  vi lzb = __builtin_lvx_bitcnt (b_m, ".lz") - (FP_SIGN_SZ + FP_EXP_SZ);      \
   ...
   *                                                                          \
   * From now on, the division works with SA and SB, which are floating-point \
   * numbers with the bias as the exponent.                                   \
   **/                                                                        \
  vf sa = vi2vf (MAKE_FP(FP_Z_I,FP_BIAS,(a_m<<(a_subnormal_p & (lza + 1))))); \
  vf sb = vi2vf (MAKE_FP(FP_Z_I,FP_BIAS,(b_m<<(b_subnormal_p & (lzb + 1))))); \
   ...
   * approximate value by using __builtin_lvx_frec.  Otherwise, we            \
   * first get a seed with  __builtin_lvx_fsrec and iterate it.               \
   **/                                                                        \
  vf y3;                                                                      \
                                                                              \
  if (!__builtin_strcmp(PROTECT(FP_TYPE), "DOUBLE"))                          \
    {                                                                         \
      vf y0     = __builtin_lvx_fsrec (sb, "");                               \
                                                                              \
      /**                                                                     \
      ...
      vf eps0 = __builtin_lvx_ffms (sb, y0, one_v1df, ".rn.s");               \
      vf y1   = __builtin_lvx_ffma (y0, eps0, y0, ".rn.s");                   \
      /* 2nd Goldsmith iteration */                                           \
      vf eps1 = __builtin_lvx_fmul (eps0, eps0, ".rn.s");                     \
      vf y2   = __builtin_lvx_ffma (y1, eps1, y1, ".rn.s");                   \
      /* 1st Newton-Raphson iteration */                                      \
      vf r    = __builtin_lvx_ffms (sb, y2, one_v1df, ".rn.s");               \
      y3      = __builtin_lvx_ffma (r, y2, y2, ".rn.s");                      \
    }                                                                         \
  else if (!__builtin_strcmp(PROTECT(FP_TYPE), "FLOAT"))                      \
      y3      = __builtin_lvx_frec (sb, "");                                  \
                                                                              \
  /**                                                                         \
   * 6. Apply Theorem 2                                                       \
   *                                                                          \
   ...
   * */                                                                       \
  vf q      = __builtin_lvx_fmul (sa, y3, ".rn.s");                           \
                                                                              \
  vf r1     = __builtin_lvx_ffms (sb, q, sa, ".rn.s");                        \
  vf q_star = __builtin_lvx_ffma (r1, y3, q, ".rn.s");                        \
                                                                              \
  vf r2     = __builtin_lvx_ffms (sb, q_star, sa, "." #mode ".s");            \
  vf q_snd  = __builtin_lvx_ffma (r2, y3, q_star, "." #mode ".s");            \
                                                                              \
  vf res = q_snd;                                                             \
  if (!__builtin_strcmp (#mode, "ru") || !__builtin_strcmp (#mode, "rd"))     \
    {                                                                         \
      vf UNUSED (q_snd_rd) = __builtin_lvx_ffma (r2, y3, q_star, ".rd.s");    \
      vf UNUSED (q_snd_ru) = __builtin_lvx_ffma (r2, y3, q_star, ".ru.s");    \
  ...
  if (!__builtin_strcmp (#mode, "rn"))                                        \
    subnormal_shift = (shift <= 0) & (-shift < (FP_MANTISSA_SZ + 2)) &        \
   ...
   **/                                                                        \
  vi offset = 10*(((shift<=-(FP_MANTISSA_SZ))&1) - ((shift>=FP_E_MAX)&1));    \
  shift += offset;                                                            \
                                                                              \
  /**                                                                         \
  ...
  vf scale = vi2vf(                                                           \
    ((shift <= 0) &                                                           \
      (((-shift > FP_MANTISSA_SZ) & 1) + (~(-shift > FP_MANTISSA_SZ) &        \
  ...
  vf resd  = __builtin_lvx_fmul (resd_, scale, "." #mode ".s");               \
                                                                              \
  /**                                                                         \
  ...
  if (!__builtin_strcmp (#mode, "rn"))                                        \
    {                                                                         \
      vi resd_d   = vf2vi(__builtin_lvx_fmul (resd_, scale, ".rd.s"));        \
      vf resd_vec = vi2vf(                                                    \
          (((subnormal_shift != 0) & (r2 != 0)) &                             \
  ...
  _res0f = __builtin_lvx_select (mnan_vf, _res0f, sel1, ".nez");              \
  _res0f = __builtin_lvx_select (nan_vf,  _res0f, sel2, ".nez");              \
  _res0f = __builtin_lvx_select (z_vf,    _res0f, sel3, ".nez");              \
  _res0f = __builtin_lvx_select (a_vf,    _res0f, sel4, ".nez");              \
  _res0f = __builtin_lvx_select (inf_vf,  _res0f, sel5, ".nez");              \
  _res0f = __builtin_lvx_select (z_vf,    _res0f, sel6, ".nez");              \
  return _res0f;                                                              \
}

#define define_selector                                                       \
fp_mode (*CONCAT2 (__divm3, _rnd)[]) (fp_mode, fp_mode) = {                   \
  CONCAT2 (__divm3, _rn), CONCAT2 (__divm3, _rd),                             \
  CONCAT2 (__divm3, _ru), CONCAT2 (__divm3, _rz),                             \
};
