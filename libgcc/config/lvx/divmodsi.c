 ...
 *
 * Routines for LVX division and modulus on 32-bit integers.
 *
...
{
  double double1 = 1.0;
  float floatb = __builtin_lvx_floatuw (b, 0,  ".rn.s");
...
{
  uint32_t absa = __builtin_lvx_absw (a, "");
  uint32_t absb = __builtin_lvx_absw (b, "");
